  ...
  <li class="nav-item">
    ...
    <tbody>
      ...
      <tr>
        ...
        <a class='btn btn-danger' href='../admin_function/admin-delete.php?nama_ruangan=$row[nama_ruangan]'onClick=\"return confirm('Do you want to Delete this data ?');\"'>Delete</a>
                </td>
      </tr>
      ";
        }
