...
if(isset($_GET['nama_ruangan'])){
  $result = mysqli_query($con, "DELETE from `ruangan` where nama_ruangan='$_GET[nama_ruangan]'");
  if($result){
  ...
  ?>
    ...
    <tbody>
      ...
      <tr>
        ...
        <a class='btn btn-danger' href='?nama_ruangan=$row[nama_ruangan]'onClick=\"return confirm('Do you want to Delete this data ?');\"'>Delete</a>
                </td>
      </tr>
      ";
        }
